...
public class BatchCancelOrders {
  ...
  public static void main(String[] args) {
    ...
    orderIds.add(181L);
    System.out.println(
        syncRequestClient.batchCancelOrders("BTCUSDT", orderIds.toJSONString(), null));
    ...
    //        System.out.println(syncRequestClient.batchCancelOrders("BTCUSDT", null,
    // origClientOrderIds.toJSONString()));
  }
}

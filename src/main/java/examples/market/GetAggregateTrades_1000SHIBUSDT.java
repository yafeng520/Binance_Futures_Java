...
public class GetAggregateTrades_1000SHIBUSDT {
  public static void main(String[] args) {
    ...
    File f =
        new File(
            "/Users/fuyafeng/IdeaProjects/Binance_Futures_Java/tmp/getFutureData1000SHIBUSDT_ByRestApi.txt");
    Writer w = null;
    try {
    ...
    while (true) {
      List<AggregateTrade> AggregateTrades_btcusdt =
          syncRequestClient.getAggregateTrades("1000SHIBUSDT", null, null, null, 20);
      count++;

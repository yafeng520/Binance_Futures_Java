...
public interface SubscriptionClient {
  ...
  /**
   * Subscribe aggregate trade event. If the aggregate trade is updated, server will send the data
   ...
   *     between client and Binance server.
   */
  ...
  /**
   * Subscribe mark price event. If the mark price is updated, server will send the data to client
  ...
  /**
   * Subscribe candlestick event. If the candlestick is updated, server will send the data to client
   * and onReceive in callback will be called.
   *
   * @param symbol The symbol, like "btcusdt".
  ...
  /**
   * Subscribe individual symbol mini ticker event. If the symbol mini ticker is updated, server
  ...
  /**
   * Subscribe all market mini tickers event. If the mini tickers are updated, server will send the
  ...
  /**
   * Subscribe individual symbol ticker event. If the symbol ticker is updated, server will send the
   * data to client and onReceive in callback will be called.
   *
   * @param symbol The symbol, like "btcusdt".
   * @param callback The implementation is required. onReceive will be called if receive server's
  ...
  /**
   * Subscribe all market tickers event. If the tickers are updated, server will send the data to
  ...
  /**
   * Subscribe individual symbol book ticker event. If the symbol book ticker is updated, server
   * will send the data to client and onReceive in callback will be called.
   *
   * @param symbol The symbol, like "btcusdt".
   * @param callback The implementation is required. onReceive will be called if receive server's
  ...
  /**
   * Subscribe all market book tickers event. If the book tickers are updated, server will send the
   * data to client and onReceive in callback will be called.
   *
   * @param callback The implementation is required. onReceive will be called if receive server's
   *     update.
  ...
  /**
   * Subscribe partial book depth event. If the book depth is updated, server will send the data to
   * client and onReceive in callback will be called.
   *
   * @param symbol The symbol, like "btcusdt".
  ...
  /**
   * Subscribe diff depth event. If the book depth is updated, server will send the data to client
   * and onReceive in callback will be called.
   *
   * @param symbol The symbol, like "btcusdt".
   * @param callback The implementation is required. onReceive will be called if receive server's
  ...
  /**
   * Subscribe user data event. If the user data is updated, server will send the data to client and

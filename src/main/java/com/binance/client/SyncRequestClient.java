 ...
 *
 * <p>If the invoking failed or timeout, the {@link
 * com.binance.client.exception.BinanceApiException} will be thrown.
 */
public interface SyncRequestClient {
  ...
  static SyncRequestClient create(String apiKey, String secretKey) {
    return BinanceApiInternalFactory.getInstance()
  ...
  static SyncRequestClient create(String apiKey, String secretKey, RequestOptions options) {
    return BinanceApiInternalFactory.getInstance()
        .createSyncRequestClient(apiKey, secretKey, options);
  }
   ...
   */
  List<Candlestick> getCandlestick(
   ...
   */
  List<LiquidationOrder> getLiquidationOrders(
  ...
  /**
   * Switch position side. (true == dual, false == single)
   *
   * @return ResponseResult.
   */
   ...
   * @return
   */
  JSONObject addIsolatedPositionMargin(
   ...
   * @return
   */
  List<WalletDeltaLog> getPositionMarginHistory(
   ...
   */
  List<OpenInterestStat> getOpenInterestStat(
   ...
   */
  List<CommonLongShortRatio> getTopTraderAccountRatio(
      String symbol, PeriodType period, Long startTime, Long endTime, Integer limit);
   ...
   */
  List<CommonLongShortRatio> getTopTraderPositionRatio(
      String symbol, PeriodType period, Long startTime, Long endTime, Integer limit);
   ...
   */
  List<CommonLongShortRatio> getGlobalAccountRatio(
      String symbol, PeriodType period, Long startTime, Long endTime, Integer limit);
   ...
   */
  List<TakerLongShortStat> getTakerLongShortRatio(
      String symbol, PeriodType period, Long startTime, Long endTime, Integer limit);
}

...
public class JsonWrapper {
    ...
    try {
      ...
      if (jsonObject != null) {
        ...
        throw new BinanceApiException(
            BinanceApiException.RUNTIME_ERROR, "[Json] Unknown error when parse: " + text);
      }
    } catch (JSONException e) {
      throw new BinanceApiException(
          BinanceApiException.RUNTIME_ERROR, "[Json] Fail to parse json: " + text);
    } catch (Exception e) {
  ...
  public JsonWrapperArray getJsonArray(String name) {
    ...
    try {
      ...
      throw new BinanceApiException(
          BinanceApiException.RUNTIME_ERROR, "[Json] Get array: " + name + " error");
    }
    if (array == null) {
      throw new BinanceApiException(
          BinanceApiException.RUNTIME_ERROR, "[Json] Array: " + name + " does not exist");
    }

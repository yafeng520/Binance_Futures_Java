...
public class WebSocketStreamClientImpl implements SubscriptionClient {
  ...
  public void subscribeCandlestickEvent(
      ...
      SubscriptionErrorHandler errorHandler) {
    createConnection(
        requestImpl.subscribeCandlestickEvent(
            symbol, interval, subscriptionListener, errorHandler));
  }
  ...
  public void subscribeSymbolLiquidationOrderEvent(
      ...
      SubscriptionErrorHandler errorHandler) {
    createConnection(
        requestImpl.subscribeSymbolLiquidationOrderEvent(
            symbol, subscriptionListener, errorHandler));
  }
